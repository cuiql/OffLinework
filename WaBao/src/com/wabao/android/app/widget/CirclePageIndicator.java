...
public class CirclePageIndicator extends View implements PageIndicator {
    ...
    // 没有选中的时候线条颜色
    private static final int UN_SELECTED_COLOR = Color.parseColor("#80FFFFFF");
    // ============================================
    // =================Config End=================
    // ============================================
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final float indicatorWidth = (count * mGapWidth) - mGapWidth;
        ...
        for (int i = 0; i < count; i++) {
            float dx1 = horizontalOffset + (i * mGapWidth);
            canvas.drawCircle(dx1, verticalOffset, 10,
    ...
    private int measureWidth(int measureSpec) {
        ...
        if ((specMode == MeasureSpec.EXACTLY) || (mViewPager == null)) {
            ...
            final int count = mViewPager.getAdapter().getCount();
            result = getPaddingLeft() + getPaddingRight() + (count * mGapWidth)
                    + ((count - 1) * mGapWidth);
